  ...
  <div class="container-fluid">
          <div class="row">
                <div class="col-xl-6 col-lg-7 col-sm-12 flex-column align-items-center">
                    <h1>Wir sind Ihr Spezialist für Websites und Online-Werbemittel</h1>
                    <p>Wir sind Medien­profis und Web Developer mit lang­jährigen Erfahrung­swerten, 
              ...
              <div class="col-xl-6 col-lg-5 col-sm-12 align-content-center">
                  <div class="outer-image">
                      <img src="https://d1zczzapudl1mr.cloudfront.net/blank-kraken.gif" alt="Webseite" data-src="@asset('images/webdev.svg')" class="lozad" />
                  </div>
              </div>
      </div>
  </div>
