  ...
  <div class="container-fluid">
    ...
    <div class="row ">
      ...
      <div class="order-2 order-xl-1 oder-md-2 order-sm-2 col-xl-6 col-lg-7 col-md-12 d-flex align-content-center flex-wrap">
        <h2>Die Installation – kompetent und komfortabel durch Intermac</h2>

        Die Inbetriebnahme des Konnektors und der weiteren Komponenten erfolgt durch einen zertifizierten TI-Techniker in Ihrer Praxis.
        Die individuellen Konfigurationsoptionen werden unter Berücksichtigung der IT-Sicherheit und Betriebssicherheit im Konnektor,
        im Kartenlesegerät und im Praxisverwaltungssystem konfiguriert.
        <br /><br />
        ...
        Zum Schutz vor unberechtigtem Zugriff kann er auch dauerhaft in einem verschlossenen Schrank betrieben werden.
        Dabei ist auf hinreichende Belüftung und Vermeidung zusätzlicher Wärmequellen (z. B. Heizkörper unter dem Aufstellort) zu achten.
        <br /><br />
      ...
      <div class="order-1 order-xl-2 oder-md-1 order-sm-1 col-xl-6 col-lg-5 col-md-12 align-items-center justify-content-center">
        <div class="embed-responsive embed-responsive-16by9 mb-5 mb-sm-0">
          <video width="100%" height="100%" controls>
            <source src="https://www.secunet.com/fileadmin/user_upload/Videos/eHealth_konnektor_animation_10.mp4" type="video/mp4">
          </video>
        </div>
      </div>
