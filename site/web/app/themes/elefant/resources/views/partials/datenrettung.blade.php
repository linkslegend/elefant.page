  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="p-3 col-xl-4 col-lg-4 col-md-12">
        <div class="inner-box">
        <div class="outer-image"><img src="https://d1zczzapudl1mr.cloudfront.net/blank-kraken.gif" alt="Versicherten stammdaten management" data-src="@asset('images/customer-service.svg')" class="lozad" /></div>
        <h2>Kontakt & Diagnose</h2>
        Rufen Sie uns an.Schicken Sie Ihr Medium ein, und wir werden uns mit Ihnen in Verbindung setzen ...
        <ul>
          <li>Verpacken Sie Ihr Medium sorgfältig.</li>
          <li>Senden Sie uns Ihr Medium sicher per DHL oder einem Kurierservice zu.</li>
        </ul>
        </div>
      </div>
      ...
      <div class="p-3 col-xl-4 col-lg-4 col-md-12">
        <div class="inner-box">
        <div class="outer-image"><img src="https://d1zczzapudl1mr.cloudfront.net/blank-kraken.gif" alt="Elektronischer Arztbrief" data-src="@asset('images/data.svg')" class="lozad" /></div>
        <h2>Datenübersicht</h2>
        Wir schicken Ihnen ein unverbindliches Preisangebot & eine Online-Datenübersicht Ihrer Daten ...
        Nachdem das Problem identifiziert und eine passende Lösung gefunden wurde,
        schicken wir Ihnen eine Übersicht aller rettbaren Daten und ein unverbindliches Preisangebot.
      </div>
      </div>

      <div class="p-3 col-xl-4 col-lg-4 col-md-12">
        <div class="inner-box">
        <div class="outer-image"><img src="https://d1zczzapudl1mr.cloudfront.net/blank-kraken.gif" alt="Elektronischer Medikationsplan" data-src="@asset('images/box.svg')" class="lozad" /></div>
        <h2>Versand Ihrer Daten</h2>
        Wir übertragen Ihre geretteten Daten auf ein neues Medium ihrer Wahl.
        Wir Schicken Ihnen Ihre Daten innerhalb 24h mit einer sicheren Versandmethode zurück.
        Für Rückfragen behalten wir für 10 Tage eine Kopie Ihrer Daten. Danach werden diese auf sichere Weise vernichtet.
      </div>
    </div>
