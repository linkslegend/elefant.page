...
import { faDownload, faHome, faPlus, faMinus, faHeart, faBox, faAddressCard, faCompressArrowsAlt, faClipboardCheck, faProjectDiagram, faDesktop, faLifeRing, faChalkboardTeacher, faFileDownload, faHandsHelping, faPhone, faEnvelope, faArrowRight, faArrowLeft} from '@fortawesome/free-solid-svg-icons';

// add the imported icons to the library
library.add(faDownload, faHome, faPlus, faMinus, faFacebook, faFacebookSquare, faTwitter, faTwitterSquare, faLinkedin, faBox, faHeart, faAddressCard, faCompressArrowsAlt, faClipboardCheck, faProjectDiagram, faDesktop, faLifeRing, faChalkboardTeacher, faFileDownload, faHandsHelping, faPhone, faEnvelope, faArrowRight, faArrowLeft);
